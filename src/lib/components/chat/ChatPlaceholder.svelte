...
{#key mounted}
	<div class="m-auto w-full max-w-[58rem] px-8 lg:px-20">
		...
		<div
			class=" mt-2 mb-4 text-3xl sm:text-4xl font-bold tracking-tight text-gray-900 dark:text-white text-left flex items-center gap-4"
		>
			<div>
						...
						{#if models[selectedModelIdx]?.info?.meta?.user}
							<div class="mt-0.5 text-sm font-normal text-gray-400 dark:text-gray-500">
								...
								{#if models[selectedModelIdx]?.info?.meta?.user.community}
									<a
										href="https://Aria.com/m/{models[selectedModelIdx]?.info?.meta?.user
											.username}"
