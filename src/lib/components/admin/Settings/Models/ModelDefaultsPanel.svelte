		...
		{:else}
			<div class="space-y-1 mt-0.5">
				<div>
					...
					{#if showCapabilities}
						<div class="pb-2" role="presentation" on:click={updateDirty} on:keydown={updateDirty} on:change={updateDirty}>
				...
				<div>
					...
					{#if showPromptSuggestions}
						<div class="pb-2" role="presentation" on:click={updateDirty} on:keydown={updateDirty} on:change={updateDirty} on:input={updateDirty}>
